...
| Masters               |    35 | `item_master`, `master_records` + 26 `erp_master_*` (LIKE-cloned) + 10 per-master DBs (payment_method, tds_section, location, gl_code, vendor_group, designation, asset_category, depreciation_method, service_type, expense_category) |
