 ...
 * Complete route definitions for the enterprise procurement system
 */

import { RouteObject } from 'react-router-dom';

// Import all page components
// Note: Update these paths once files are moved to /src/pages/*
...
import { ExchangeRateMaster } from '../components/ExchangeRateMaster';
...
import { VendorPaymentTermsMaster } from '../components/VendorPaymentTermsMaster';
 ...
 * This can be used with createBrowserRouter or as a reference
 */
export const routeConfig: RouteObject[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'dashboards', element: <DashboardsHub /> },
      ...
      { path: 'purchase-orders/create-from-pr', element: <PRSelectionPage /> },
      ...
      { path: 'invoices/create-direct', element: <InvoiceFormDirect /> },
      ...
      // Debit Notes
      { path: 'ap/debit-notes', element: <DebitNotes /> },
      { path: 'ap/debit-notes/create', element: <DebitNoteFormV2Enhanced /> },
      { path: 'ap/debit-notes/edit/:id', element: <DebitNoteFormV2Enhanced /> },
      { path: 'ap/debit-notes/detail/:id', element: <DebitNoteDetail /> },
      ...
      { path: 'masters/entity-master', element: <EntityMaster /> },
      { path: 'masters/currency-master', element: <CurrencyMaster /> },
      { path: 'masters/exchange-rate-master', element: <ExchangeRateMaster /> },
      ...
      { path: 'masters/item-category-master', element: <ItemCategoryMaster /> },
      { path: 'masters/vendor-payment-terms-master', element: <VendorPaymentTermsMaster /> },
...
export const routeMetadata: Record<string, RouteMetadata> = {
  '/': { path: '/', title: 'Dashboard', module: 'Dashboard', requiresAuth: true },
  '/purchase-orders': { path: '/purchase-orders', title: 'Purchase Orders', module: 'Procurement', requiresAuth: true },
  '/vendors': { path: '/vendors', title: 'Vendors', module: 'Vendors', requiresAuth: true },
  '/invoices': { path: '/invoices', title: 'Invoices', module: 'AP', requiresAuth: true },
  '/ap/debit-notes': { path: '/ap/debit-notes', title: 'Debit Notes', module: 'AP', requiresAuth: true },
  '/ap/payments': { path: '/ap/payments', title: 'Payments', module: 'Payments', requiresAuth: true },
  '/ap/advances': { path: '/ap/advances', title: 'Advances', module: 'Advances', requiresAuth: true },
  '/masters': { path: '/masters', title: 'Master Data', module: 'Masters', requiresAuth: true },
  '/reports': { path: '/reports', title: 'Reports', module: 'Reports', requiresAuth: true },
  '/budget-dashboard': { path: '/budget-dashboard', title: 'Budgets', module: 'Budgeting', requiresAuth: true },
};
