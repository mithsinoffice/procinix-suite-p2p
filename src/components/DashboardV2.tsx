    ...
    () =>
      [
        ...
        { name: 'Approved', value: metrics.poStatusBreakdown.approved, color: 'var(--color-teal)' },
        {
          ...
          value: metrics.poStatusBreakdown.partiallyReceived,
          color: '#D97706',
        },
        {
          name: 'Fully Received',
          value: metrics.poStatusBreakdown.fullyReceived,
          color: '#10B981',
        },
        {
          name: 'Closed',
          value: metrics.poStatusBreakdown.closed,
          color: 'var(--color-mercury-grey)',
        },
      ].filter((item) => item.value > 0),
    [metrics.poStatusBreakdown]
  );
      ...
      [
        {
          ...
          value: metrics.invoiceStatusBreakdown.pendingApproval,
          color: '#D97706',
        },
        {
          name: 'Approved',
          value: metrics.invoiceStatusBreakdown.approved,
          color: 'var(--color-teal)',
        },
        { name: 'Paid', value: metrics.invoiceStatusBreakdown.paid, color: '#10B981' },
        {
          name: 'Overdue',
          value: metrics.invoiceStatusBreakdown.overdue,
                  ...
                  <BarChart data={poVolumeTrendData}>
                    ...
                    <Tooltip
                      ...
                      formatter={(value: number, name: string) => {
                        if (name === 'value')
                          return [`${formatCurrency(value * 1000)}`, 'PO Value'];
              ...
              <div className="space-y-4">
                ...
                >
                  <div>
                    ...
                    <p
                      className="text-xl"
                      style={{ color: 'var(--color-ink)', margin: '4px 0 0 0' }}
                    >
                      {metrics.grnCount}
                    </p>
                  </div>
                ...
                >
                  <div>
                    ...
                    <p className="text-xl" style={{ color: '#D97706', margin: '4px 0 0 0' }}>
                ...
                >
                  <div>
                    ...
                    <p
                      className="text-xl"
                      style={{ color: 'var(--color-error)', margin: '4px 0 0 0' }}
                    >
                      {formatCurrency(metrics.totalDebitNotes)}
                    </p>
                  </div>
                  <FileEdit
