        ...
        <div style={{ overflow: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              ...
              {[
                {
                  time: '2024-12-14 10:30:15',
                  user: 'Rajesh Kumar',
                  action: 'Created',
                  module: 'Purchase Order',
                  details: 'PO-2024-0156',
                },
                {
                  time: '2024-12-14 10:15:42',
                  user: 'Priya Sharma',
                  action: 'Approved',
                  module: 'Invoice',
                  details: 'INV-2024-0891',
                },
                {
                  time: '2024-12-14 09:45:23',
                  user: 'Amit Patel',
                  action: 'Updated',
                ...
                {
                  time: '2024-12-14 09:20:11',
                  user: 'Sneha Gupta',
                  action: 'Created',
                  module: 'GRN',
                  details: 'GRN-2024-0234',
                },
                {
                  time: '2024-12-14 08:55:33',
                  user: 'Vikram Singh',
                  action: 'Rejected',
                  module: 'Payment Batch',
                  details: 'PB-2024-0067',
                },
              ].map((log, index) => (
