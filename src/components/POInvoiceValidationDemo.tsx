    ...
    <div className="min-h-screen" style={{ backgroundColor: '#F6F9FC' }}>
      ...
      <div className="bg-white px-8 py-6" style={{ borderBottom: '2px solid #E1E6EA' }}>
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl" style={{ color: '#0A0F14', fontWeight: '700' }}>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              style={{ border: '1px solid #E1E6EA', color: '#0A0F14', fontWeight: '500' }}
      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="bg-white rounded-xl p-6 mb-6" style={{ border: '2px solid #E1E6EA' }}>
          <h2 className="text-xl mb-4" style={{ color: '#0A0F14', fontWeight: '700' }}>
            Smart Validation Features
          </h2>
          <div className="grid grid-cols-3 gap-4">
            <div className="p-4 rounded-lg" style={{ backgroundColor: '#E8F7F8', border: '1px solid #00A9B7' }}>
              <div className="flex items-center gap-2 mb-2">
                <Lock className="w-5 h-5" style={{ color: '#00A9B7' }} />
                <h3 className="text-sm" style={{ color: '#0A0F14', fontWeight: '600' }}>Rate Lock Control</h3>
              </div>
              <p className="text-sm" style={{ color: '#6E7A82' }}>
                Invoice rates locked to PO rates with visual indicators and helpful tooltips
              </p>
            </div>
            <div className="p-4 rounded-lg" style={{ backgroundColor: '#FFF9E6', border: '1px solid #D97706' }}>
              <div className="flex items-center gap-2 mb-2">
                <AlertTriangle className="w-5 h-5" style={{ color: '#D97706' }} />
                <h3 className="text-sm" style={{ color: '#0A0F14', fontWeight: '600' }}>Exception Workflow</h3>
              </div>
              <p className="text-sm" style={{ color: '#6E7A82' }}>
                Structured exception requests with approval routing to CFO/Finance Manager
              </p>
            </div>
            <div className="p-4 rounded-lg" style={{ backgroundColor: '#F3E5F5', border: '1px solid #7B1FA2' }}>
              <div className="flex items-center gap-2 mb-2">
                <CheckCircle className="w-5 h-5" style={{ color: '#7B1FA2' }} />
                <h3 className="text-sm" style={{ color: '#0A0F14', fontWeight: '600' }}>3-Way Match</h3>
              </div>
              <p className="text-sm" style={{ color: '#6E7A82' }}>
        ...
        <div className="bg-white rounded-xl p-6 mb-6" style={{ border: '2px solid #E1E6EA' }}>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-lg" style={{ color: '#0A0F14', fontWeight: '700' }}>Smart Rate Validation</h2>
              <p className="text-sm" style={{ color: '#6E7A82' }}>
          ...
          <div className="grid grid-cols-2 gap-6">
            {/* Hard Lock Example */}
            <div className="p-4 rounded-lg" style={{ border: '2px solid #E1E6EA' }}>
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-sm" style={{ color: '#0A0F14', fontWeight: '600' }}>
                  Hard Lock (Default)
                </h3>
                <span className="px-2 py-1 rounded text-xs" style={{ backgroundColor: '#E8F7F8', color: '#00A9B7', fontWeight: '600' }}>
                  RECOMMENDED
                </span>
              </div>
              <div className="space-y-3">
                <div className="relative">
                  <label className="block text-xs mb-1" style={{ color: '#6E7A82', fontWeight: '600' }}>
                    Unit Rate
                  </label>
                  <div className="relative">
                    <input
                    ...
                    />
                    <Lock className="absolute right-3 top-2.5 w-4 h-4" style={{ color: '#6E7A82' }} />
                  </div>
                ...
                <div className="bg-blue-50 p-3 rounded" style={{ border: '1px solid #00A9B7' }}>
                  <p className="text-xs" style={{ color: '#0A0F14' }}>
                    <strong>Behavior:</strong> Field is read-only. Tooltip explains: "Rate cannot exceed PO rate. To change rate, amend the PO or request an exception."
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg" style={{ border: '2px solid #E1E6EA' }}>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="px-2 py-1 rounded text-xs" style={{ backgroundColor: '#FFF9E6', color: '#D97706', fontWeight: '600' }}>
                  REQUIRES APPROVAL
                </span>
              </div>
              <div className="space-y-3">
                <div className="relative">
                  ...
                  <input
                    ...
                    value="₹465.00"
                    className="w-full px-3 py-2 rounded text-sm"
                    style={{ border: '2px solid #FF4E5B', backgroundColor: '#FEE2E2', color: '#0A0F14', fontWeight: '600' }}
                  />
                  <div className="flex items-center justify-between mt-1 text-xs">
                    <span style={{ color: '#6E7A82' }}>PO: ₹450.00</span>
                    <span style={{ color: '#FF4E5B' }}>+3.3%</span>
                  </div>
                </div>
                <div className="bg-red-50 p-3 rounded" style={{ border: '1px solid #FF4E5B' }}>
                  <div className="flex items-start gap-2 mb-2">
                    <AlertTriangle className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: '#FF4E5B' }} />
                    <p className="text-xs" style={{ color: '#FF4E5B', fontWeight: '600' }}>
        ...
        <div className="bg-white rounded-xl p-6 mb-6" style={{ border: '2px solid #E1E6EA' }}>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-lg" style={{ color: '#0A0F14', fontWeight: '700' }}>Exception Handling Workflow</h2>
              <p className="text-sm" style={{ color: '#6E7A82' }}>
          ...
          <div className="grid grid-cols-4 gap-4">
            <div className="text-center">
              <div className="w-12 h-12 rounded-full mx-auto mb-2 flex items-center justify-center" style={{ backgroundColor: '#FEE2E2' }}>
                <AlertTriangle className="w-6 h-6" style={{ color: '#FF4E5B' }} />
              </div>
              <h4 className="text-sm mb-1" style={{ color: '#0A0F14', fontWeight: '600' }}>1. Validation Error</h4>
              <p className="text-xs" style={{ color: '#6E7A82' }}>
            ...
            <div className="text-center">
              <div className="w-12 h-12 rounded-full mx-auto mb-2 flex items-center justify-center" style={{ backgroundColor: '#E8F7F8' }}>
                <TrendingUp className="w-6 h-6" style={{ color: '#00A9B7' }} />
              </div>
              <h4 className="text-sm mb-1" style={{ color: '#0A0F14', fontWeight: '600' }}>2. Exception Request</h4>
              <p className="text-xs" style={{ color: '#6E7A82' }}>
            ...
            <div className="text-center">
              <div className="w-12 h-12 rounded-full mx-auto mb-2 flex items-center justify-center" style={{ backgroundColor: '#FFF9E6' }}>
                <Shield className="w-6 h-6" style={{ color: '#D97706' }} />
              </div>
              <h4 className="text-sm mb-1" style={{ color: '#0A0F14', fontWeight: '600' }}>3. CFO Review</h4>
              <p className="text-xs" style={{ color: '#6E7A82' }}>
            ...
            <div className="text-center">
              <div className="w-12 h-12 rounded-full mx-auto mb-2 flex items-center justify-center" style={{ backgroundColor: '#DCFCE7' }}>
                <CheckCircle className="w-6 h-6" style={{ color: '#16A34A' }} />
              </div>
              <h4 className="text-sm mb-1" style={{ color: '#0A0F14', fontWeight: '600' }}>4. Resolution</h4>
              <p className="text-xs" style={{ color: '#6E7A82' }}>
          ...
          <div className="mt-6 p-4 rounded-lg" style={{ backgroundColor: '#F6F9FC', border: '1px solid #E1E6EA' }}>
            <h4 className="text-sm mb-2" style={{ color: '#0A0F14', fontWeight: '600' }}>
              Exception Modal Includes:
            </h4>
            <ul className="space-y-1 text-sm" style={{ color: '#6E7A82' }}>
        ...
        <div className="bg-white rounded-xl p-6 mb-6" style={{ border: '2px solid #E1E6EA' }}>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-lg" style={{ color: '#0A0F14', fontWeight: '700' }}>3-Way Match Validation Rules</h2>
              <p className="text-sm" style={{ color: '#6E7A82' }}>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-3 gap-4">
              <div className="p-4 rounded-lg" style={{ backgroundColor: '#E8F7F8', border: '1px solid #00A9B7' }}>
                <h4 className="text-xs mb-2" style={{ color: '#6E7A82', fontWeight: '700' }}>RULE 1: QUANTITY</h4>
              ...
              <div className="p-4 rounded-lg" style={{ backgroundColor: '#E8F7F8', border: '1px solid #00A9B7' }}>
                <h4 className="text-xs mb-2" style={{ color: '#6E7A82', fontWeight: '700' }}>RULE 2: LINE AMOUNT</h4>
                <p className="text-sm mb-2" style={{ color: '#0A0F14', fontWeight: '600' }}>
              ...
              <div className="p-4 rounded-lg" style={{ backgroundColor: '#E8F7F8', border: '1px solid #00A9B7' }}>
                <h4 className="text-xs mb-2" style={{ color: '#6E7A82', fontWeight: '700' }}>RULE 3: CUMULATIVE</h4>
                <p className="text-sm mb-2" style={{ color: '#0A0F14', fontWeight: '600' }}>
            ...
            <div className="p-4 rounded-lg" style={{ backgroundColor: '#F6F9FC', border: '1px solid #E1E6EA' }}>
              <h4 className="text-sm mb-3" style={{ color: '#0A0F14', fontWeight: '600' }}>
                Visual & Contextual Cues in Line Item Table:
              </h4>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <h5 className="text-xs mb-2" style={{ color: '#6E7A82', fontWeight: '700' }}>DISPLAYED INFORMATION</h5>
                  <ul className="space-y-1 text-sm" style={{ color: '#0A0F14' }}>
                ...
                <div>
                  <h5 className="text-xs mb-2" style={{ color: '#6E7A82', fontWeight: '700' }}>INLINE VALIDATIONS</h5>
                  <ul className="space-y-1 text-sm" style={{ color: '#0A0F14' }}>
        ...
        <div className="bg-white rounded-xl p-6" style={{ border: '2px solid #E1E6EA' }}>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-lg" style={{ color: '#0A0F14', fontWeight: '700' }}>Policy & Configuration</h2>
              <p className="text-sm" style={{ color: '#6E7A82' }}>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <div className="space-y-2 text-sm" style={{ color: '#6E7A82' }}>
