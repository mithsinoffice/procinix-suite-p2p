      ...
      <div className="max-w-7xl mx-auto p-8">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="p-4 rounded-lg" style={{ backgroundColor: 'var(--color-teal-tint)', border: '1px solid var(--color-teal)' }}>
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-sm" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>Rate Lock Control</h3>
              </div>
            ...
            <div className="p-4 rounded-lg" style={{ backgroundColor: '#FFF9E6', border: '1px solid #D97706' }}>
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-sm" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>Exception Workflow</h3>
              </div>
              <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
            ...
            <div className="p-4 rounded-lg" style={{ backgroundColor: '#F3E5F5', border: '1px solid #7B1FA2' }}>
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-sm" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>3-Way Match</h3>
              </div>
              <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
        ...
        <div className="bg-white rounded-xl p-6 mb-6" style={{ border: '2px solid var(--color-silver)' }}>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-lg" style={{ color: 'var(--color-ink)', fontWeight: '700' }}>Smart Rate Validation</h2>
              <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="p-4 rounded-lg" style={{ border: '2px solid var(--color-silver)' }}>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="px-2 py-1 rounded text-xs" style={{ backgroundColor: 'var(--color-teal-tint)', color: 'var(--color-teal)', fontWeight: '600' }}>
                  RECOMMENDED
                </span>
              </div>
              <div className="space-y-3">
                <div className="relative">
                  <label className="block text-xs mb-1" style={{ color: 'var(--color-mercury-grey)', fontWeight: '600' }}>
                    Unit Rate
                  </label>
                  <div className="relative">
                    <input
                    ...
                    />
                    <Lock className="absolute right-3 top-2.5 w-4 h-4" style={{ color: 'var(--color-mercury-grey)' }} />
                  </div>
                ...
                <div className="bg-blue-50 p-3 rounded" style={{ border: '1px solid var(--color-teal)' }}>
              ...
              <div className="space-y-3">
                <div className="relative">
                  ...
                  <input
                    ...
                    value="₹465.00"
                    className="w-full px-3 py-2 rounded text-sm"
                    style={{ border: '2px solid var(--color-error)', backgroundColor: 'var(--color-error-light)', color: 'var(--color-ink)', fontWeight: '600' }}
                  />
                ...
                <div className="bg-red-50 p-3 rounded" style={{ border: '1px solid var(--color-error)' }}>
                  <div className="flex items-start gap-2 mb-2">
                    <AlertTriangle className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: 'var(--color-error)' }} />
        ...
        <div className="bg-white rounded-xl p-6 mb-6" style={{ border: '2px solid var(--color-silver)' }}>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-lg" style={{ color: 'var(--color-ink)', fontWeight: '700' }}>Exception Handling Workflow</h2>
              <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
          ...
          <div className="grid grid-cols-4 gap-4">
            <div className="text-center">
              <div className="w-12 h-12 rounded-full mx-auto mb-2 flex items-center justify-center" style={{ backgroundColor: 'var(--color-error-light)' }}>
                <AlertTriangle className="w-6 h-6" style={{ color: 'var(--color-error)' }} />
              </div>
              <h4 className="text-sm mb-1" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>1. Validation Error</h4>
              <p className="text-xs" style={{ color: 'var(--color-mercury-grey)' }}>
            ...
            <div className="text-center">
              <div className="w-12 h-12 rounded-full mx-auto mb-2 flex items-center justify-center" style={{ backgroundColor: 'var(--color-teal-tint)' }}>
                <TrendingUp className="w-6 h-6" style={{ color: 'var(--color-teal)' }} />
              </div>
              <h4 className="text-sm mb-1" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>2. Exception Request</h4>
              <p className="text-xs" style={{ color: 'var(--color-mercury-grey)' }}>
            ...
            <div className="text-center">
              ...
              <h4 className="text-sm mb-1" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>3. CFO Review</h4>
              <p className="text-xs" style={{ color: 'var(--color-mercury-grey)' }}>
            ...
            <div className="text-center">
              ...
              <h4 className="text-sm mb-1" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>4. Resolution</h4>
              <p className="text-xs" style={{ color: 'var(--color-mercury-grey)' }}>
        ...
        <div className="bg-white rounded-xl p-6 mb-6" style={{ border: '2px solid var(--color-silver)' }}>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-lg" style={{ color: 'var(--color-ink)', fontWeight: '700' }}>3-Way Match Validation Rules</h2>
              <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-3 gap-4">
              <div className="p-4 rounded-lg" style={{ backgroundColor: 'var(--color-teal-tint)', border: '1px solid var(--color-teal)' }}>
                <h4 className="text-xs mb-2" style={{ color: 'var(--color-mercury-grey)', fontWeight: '700' }}>RULE 1: QUANTITY</h4>
              ...
              <div className="p-4 rounded-lg" style={{ backgroundColor: 'var(--color-teal-tint)', border: '1px solid var(--color-teal)' }}>
                <h4 className="text-xs mb-2" style={{ color: 'var(--color-mercury-grey)', fontWeight: '700' }}>RULE 2: LINE AMOUNT</h4>
                <p className="text-sm mb-2" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>
              ...
              <div className="p-4 rounded-lg" style={{ backgroundColor: 'var(--color-teal-tint)', border: '1px solid var(--color-teal)' }}>
                <h4 className="text-xs mb-2" style={{ color: 'var(--color-mercury-grey)', fontWeight: '700' }}>RULE 3: CUMULATIVE</h4>
                <p className="text-sm mb-2" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>
            ...
            <div className="p-4 rounded-lg" style={{ backgroundColor: 'var(--color-cloud)', border: '1px solid var(--color-silver)' }}>
              <h4 className="text-sm mb-3" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>
                Visual & Contextual Cues in Line Item Table:
              </h4>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <h5 className="text-xs mb-2" style={{ color: 'var(--color-mercury-grey)', fontWeight: '700' }}>DISPLAYED INFORMATION</h5>
                ...
                <div>
                  <h5 className="text-xs mb-2" style={{ color: 'var(--color-mercury-grey)', fontWeight: '700' }}>INLINE VALIDATIONS</h5>
                  <ul className="space-y-1 text-sm" style={{ color: 'var(--color-ink)' }}>
        ...
        <div className="bg-white rounded-xl p-6" style={{ border: '2px solid var(--color-silver)' }}>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-lg" style={{ color: 'var(--color-ink)', fontWeight: '700' }}>Policy & Configuration</h2>
              <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
