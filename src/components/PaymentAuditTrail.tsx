    ...
    <div style={{ backgroundColor: '#F6F9FC', minHeight: '100vh' }}>
      ...
      <div className="p-8 max-w-[1600px] mx-auto">
          ...
          <div className="bg-white rounded-lg p-6" style={{ border: '1px solid #E1E6EA' }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-xs" style={{ color: '#6E7A82' }}>Total Payments</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6" style={{ border: '1px solid #E1E6EA' }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-xs" style={{ color: '#6E7A82' }}>Success Rate</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6" style={{ border: '1px solid #E1E6EA' }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-xs" style={{ color: '#6E7A82' }}>Discounts Captured</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6" style={{ border: '1px solid #E1E6EA' }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-xs" style={{ color: '#6E7A82' }}>Discounts Missed</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6 mb-8">
          {/* Success Rate Trend */}
          <div className="bg-white rounded-lg p-6" style={{ border: '1px solid #E1E6EA' }}>
            <h3 className="mb-4" style={{ color: '#0A0F14', fontWeight: '700', fontSize: '16px' }}>
              Payment Success Rate
            </h3>
            <ResponsiveContainer width="100%" height={200}>
              <LineChart data={successRateData}>
                <CartesianGrid strokeDasharray="3 3" stroke="#E1E6EA" />
                <XAxis dataKey="period" tick={{ fill: '#6E7A82', fontSize: 11 }} />
                <YAxis tick={{ fill: '#6E7A82', fontSize: 11 }} />
                <Tooltip
                  contentStyle={{
                    backgroundColor: '#FFFFFF',
                    border: '1px solid #E1E6EA',
        ...
        <div className="grid grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
            ...
            <div className="divide-y" style={{ borderColor: '#E1E6EA', maxHeight: '600px', overflowY: 'auto' }}>
              {filteredTraces.map((trace) => (
                <div
                  key={trace.invoiceNo}
                  className="p-4 cursor-pointer transition-colors"
                  style={{
                    backgroundColor: selectedTrace === trace.invoiceNo ? '#F6F9FC' : '#FFFFFF',
                  }}
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-sm" style={{ color: '#00A9B7', fontWeight: '700' }}>
                      {formatCurrency(trace.amount, trace.currency)}
                    </div>
                    <div className="flex items-center gap-1 text-xs" style={{ color: '#6E7A82' }}>
                      {trace.paymentMode}
          ...
          <div className="bg-white rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
            ...
            {selectedTraceData ? (
              <div className="p-6">
                {/* Summary */}
                <div className="mb-6 p-4 rounded-lg" style={{ backgroundColor: '#F6F9FC' }}>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <div className="text-xs mb-1" style={{ color: '#6E7A82' }}>Invoice No</div>
                      <div style={{ color: '#0A0F14', fontWeight: '700' }}>{selectedTraceData.invoiceNo}</div>
                    </div>
                    <div>
                      <div className="text-xs mb-1" style={{ color: '#6E7A82' }}>Amount</div>
                      <div style={{ color: '#00A9B7', fontWeight: '700' }}>
                        {formatCurrency(selectedTraceData.amount, selectedTraceData.currency)}
                      </div>
                    </div>
                    <div>
                      <div className="text-xs mb-1" style={{ color: '#6E7A82' }}>Payment Mode</div>
                      <div style={{ color: '#0A0F14', fontWeight: '600' }}>{selectedTraceData.paymentMode}</div>
                    </div>
                    {selectedTraceData.bankReference && (
                      <div>
                        <div className="text-xs mb-1" style={{ color: '#6E7A82' }}>Bank Reference</div>
                    ...
                    <div key={index} className="flex gap-4">
                      <div className="flex flex-col items-center">
                        <div
                          ...
                          style={{
                            backgroundColor: event.timestamp === 'Pending' ? '#F59E0B' : '#00A9B7',
                          }}
                        />
                        {index < selectedTraceData.timeline.length - 1 && (
                          <div className="flex-1 w-0.5 mt-2" style={{ backgroundColor: '#E1E6EA', minHeight: '40px' }} />
                        )}
                      </div>
                      <div className="flex-1 pb-4">
                        <div className="flex items-center justify-between mb-1">
                          <div style={{ color: '#0A0F14', fontWeight: '700', fontSize: '13px' }}>
                            {event.stage}
                          </div>
                          <div className="text-xs" style={{ color: '#6E7A82' }}>
                        ...
                        <div className="text-sm mb-1" style={{ color: '#6E7A82' }}>
                          {event.action}
                        </div>
                        <div className="flex items-center gap-1 text-xs" style={{ color: '#9AA6AF' }}>
              ...
              <div className="p-12 text-center" style={{ color: '#9AA6AF' }}>
            ...
            <table className="w-full">
              <thead>
                <tr style={{ backgroundColor: '#F6F9FC', borderBottom: '1px solid #E1E6EA' }}>
                  ...
                  <th className="text-right px-6 py-3 text-xs" style={{ color: '#6E7A82', fontWeight: '700' }}>
                    LAST AMOUNT
                  </th>
                </tr>
              </thead>
                ...
                {vendorPaymentHistory.map((vendor, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-4 text-right">
                      <span style={{ color: '#00A9B7', fontWeight: '700', fontSize: '14px' }}>
                    ...
                    <td className="px-4 py-4 text-center">
                      <span
                        className="px-2 py-1 rounded text-xs"
                        style={{
                          backgroundColor: vendor.onTimePercentage >= 90 ? '#D1FAE5' : vendor.onTimePercentage >= 75 ? '#FEF3C7' : '#FEE2E2',
