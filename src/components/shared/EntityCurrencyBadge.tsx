...
export function EntityCurrencyBadge({ 
  ...
  if (variant === 'compact') {
    return (
      <div className={`inline-flex items-center gap-3 px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-md ${className}`}>
  ...
  return (
    <div className={`inline-flex items-center gap-4 px-4 py-2.5 bg-gradient-to-r from-slate-50 to-slate-100 border border-slate-200 rounded-lg ${className}`}>
