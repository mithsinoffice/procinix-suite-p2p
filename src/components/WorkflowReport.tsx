...
export function WorkflowReport() {
    ...
    },
    {
      ...
      workflowHistory: [
        ...
        },
        {
          ...
          role: 'PO Approver',
          comments:
            'GST certificate expired. Please obtain updated certificate before resubmission.',
          status: 'Rejected',
        },
      ],
    },
  ...
  const pendingRecords = workflowRecords.filter(
    (r) => r.currentStatus === 'Pending Approval'
  ).length;
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
              Track all transactions and their approval workflow history
            </p>
          </div>
        </div>
        <button
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl" style={{ color: 'var(--color-teal)' }}>
                {approvedRecords}
              </p>
            </div>
            <div
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl" style={{ color: '#EF4444' }}>
                {rejectedRecords}
              </p>
            </div>
            <div
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-2xl mb-2" style={{ color: 'var(--color-ink)' }}>
                  Workflow History
                </h2>
                <div
                ...
                >
                  <span>
                    <strong>Record:</strong> {selectedRecord.recordCode} -{' '}
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  {(() => {
                    ...
                    return (
                      <StatusIcon
                        className="w-6 h-6"
                        style={{ color: getStatusColor(selectedRecord.currentStatus) }}
                      />
                    );
                  })()}
                  <div>
                ...
                <div className="text-right">
                  ...
                  <p className="text-lg" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>
                    {selectedRecord.daysInWorkflow}{' '}
                    {selectedRecord.daysInWorkflow === 1 ? 'day' : 'days'}
                  </p>
                </div>
              </div>
            </div>
