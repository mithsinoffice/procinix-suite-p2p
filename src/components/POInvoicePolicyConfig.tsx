      ...
      <div className="max-w-7xl mx-auto p-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
                Primary validation rules for PO-based invoices
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            >
              <div className="flex-1">
                ...
                <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
                  Invoice rate cannot exceed PO rate under any circumstances. Rate field is
                  read-only and locked to PO value. Any rate increase requires PO amendment or
              ...
              <label className="relative inline-flex items-center cursor-pointer ml-4">
                ...
                <div
                  ...
                  style={{
                    backgroundColor: hardLockRate ? 'var(--color-teal)' : 'var(--color-silver)',
                  }}
                ></div>
              </label>
            </div>
            ...
            >
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  <h3 className="text-sm" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>
                    Allow Tolerance-Based Override
                  </h3>
                  {!hardLockRate && (
                    <span
                      className="px-2 py-0.5 rounded text-xs"
                ...
                <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
                  Allow invoice rate to exceed PO rate within configured tolerance limits. Requires
                  approval workflow if exceeded. This option is disabled when "Hard Lock Rate" is
                  enabled.
                </p>
                {!hardLockRate && (
                  <div
                  ...
                  >
                    <p className="text-xs" style={{ color: '#D97706' }}>
                      ⚠️ When enabled, configure tolerance rules below to define acceptable variance
                      limits by vendor category, item type, etc.
                    </p>
                  </div>
                )}
              </div>
              <label className="relative inline-flex items-center cursor-pointer ml-4">
                ...
                />
                <div
                  className={`w-11 h-6 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all ${hardLockRate ? 'opacity-50 cursor-not-allowed' : ''}`}
                  style={{
                    backgroundColor: allowToleranceOverride
                      ? 'var(--color-teal)'
                      : 'var(--color-silver)',
                  }}
                ></div>
            ...
            >
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  <h3 className="text-sm" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>
                    Enforce 3-Way Match (PO → GRN → Invoice)
                  </h3>
                  <span
                    className="px-2 py-0.5 rounded text-xs"
                    style={{
                ...
                <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
                  Invoice quantity and amount must match GRN and PO within tolerance. Block
                  submission if mismatch detected.
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer ml-4">
                <input
                ...
                <div
                  className="w-11 h-6 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"
                  style={{
                    backgroundColor: enforce3WayMatch ? 'var(--color-teal)' : 'var(--color-silver)',
                  }}
                ></div>
              </label>
            </div>
            ...
            >
              <div className="flex-1">
                ...
                >
                  Block Excessive Quantity Invoicing
                </h3>
                <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
                  Invoice quantity cannot exceed GRN quantity or PO remaining balance. Prevents
                  over-invoicing.
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer ml-4">
                ...
                <div
                  className="w-11 h-6 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"
                  style={{
                    backgroundColor: blockExcessiveQuantity
                      ? 'var(--color-teal)'
                      : 'var(--color-silver)',
                  }}
                ></div>
            ...
            >
              <div className="flex-1">
                <h3
                  ...
                  style={{ color: 'var(--color-ink)', fontWeight: '600' }}
                >
                  Require GRN for Invoice Creation
                </h3>
                <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
                  Invoice can only be created after GRN is recorded. Ensures goods receipt
              ...
              <label className="relative inline-flex items-center cursor-pointer ml-4">
                ...
                <div
                  className="w-11 h-6 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"
                  style={{
                    backgroundColor: requireGRNForInvoice
                      ? 'var(--color-teal)'
                      : 'var(--color-silver)',
                  }}
                ></div>
            ...
            >
              <div className="flex-1">
                ...
                <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
                  Record all attempts to override rate, quantity, or amount in audit trail. Required
              ...
              <label className="relative inline-flex items-center cursor-pointer ml-4">
                ...
                <div
                  className="w-11 h-6 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"
                  style={{
                    backgroundColor: logAllAttempts ? 'var(--color-teal)' : 'var(--color-silver)',
                  }}
                ></div>
              </label>
            </div>
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
                    Define acceptable variance limits by vendor category, item type, PO type, and
                    department
                  </p>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-3">
                    ...
                    >
                      ...
                      <p
                        ...
                        style={{ color: 'var(--color-ink)', fontWeight: '700' }}
                      >
                        ₹{rule.maxAmountIncrease.toLocaleString()}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="pt-3" style={{ borderTop: '1px solid var(--color-silver)' }}>
                    <p
                      ...
                      style={{ color: 'var(--color-mercury-grey)', fontWeight: '600' }}
                    >
                      Approvers (if tolerance breached)
                    </p>
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: 'var(--color-mercury-grey)' }}>
              These policies apply to all PO-based invoice creation across the organization. Changes
              will take effect immediately and will be logged in the system audit trail. Users will
              see validation messages inline during invoice creation.
            </p>
          </div>
        </div>
      </div>
