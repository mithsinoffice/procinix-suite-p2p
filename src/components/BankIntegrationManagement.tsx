...
export function BankIntegrationManagement() {
  ...
  const getStatusBadge = (status: string) => {
    const config = {
      ...
      offline: { label: 'Offline', bg: '#FEE2E2', color: '#EF4444', icon: XCircle },
      ...
      <div className="p-8 max-w-[1600px] mx-auto">
          ...
          <div className="bg-white rounded-lg p-6" style={{ border: '1px solid #E1E6EA' }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-xs" style={{ color: '#6E7A82' }}>Active Accounts</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6" style={{ border: '1px solid #E1E6EA' }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-xs" style={{ color: '#6E7A82' }}>Banks Online</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6" style={{ border: '1px solid #E1E6EA' }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-xs" style={{ color: '#6E7A82' }}>Failed (24h)</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6" style={{ border: '1px solid #E1E6EA' }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-xs" style={{ color: '#6E7A82' }}>Payment Modes</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-4">
            <Building2 className="w-5 h-5" style={{ color: '#00A9B7' }} />
            <h2 style={{ color: '#0A0F14', fontWeight: '700', fontSize: '18px' }}>
              Bank Accounts
            </h2>
          </div>
            ...
            {activeAccounts.map((account) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-start gap-4">
                    <div className="p-3 rounded-lg" style={{ backgroundColor: '#F6F9FC' }}>
                      <Building2 className="w-6 h-6" style={{ color: '#00A9B7' }} />
                    </div>
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {account.isPrimary && (
                          <span
                            ...
                            style={{ backgroundColor: '#E0F2F1', color: '#00A9B7', fontWeight: '700' }}
                          >
                            PRIMARY
                          </span>
                        )}
                ...
                <div className="grid grid-cols-6 gap-6">
                  {/* Account Details */}
                  <div>
                    <div className="text-xs mb-1" style={{ color: '#6E7A82', fontWeight: '600' }}>
                      Account Number
                    </div>
                    <div className="text-sm" style={{ color: '#0A0F14', fontWeight: '600', fontFamily: 'monospace' }}>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1">
                      <Clock className="w-3.5 h-3.5" style={{ color: '#00A9B7' }} />
                ...
                <div className="mt-4 pt-4" style={{ borderTop: '1px solid #E1E6EA' }}>
                  <div className="text-xs mb-2" style={{ color: '#6E7A82', fontWeight: '700' }}>
                ...
                {/* Last Sync */}
                <div className="mt-3 flex items-center gap-2 text-xs" style={{ color: '#9AA6AF' }}>
          ...
          {inactiveAccounts.length > 0 && (
            <div className="mt-6">
              <div className="text-sm mb-3" style={{ color: '#6E7A82', fontWeight: '600' }}>
