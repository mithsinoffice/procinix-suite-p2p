    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <h2 className="text-2xl" style={{ color: 'var(--color-ink)' }}>Purchase Order Preview</h2>
          ...
          <div className="p-8" id="po-document">
            {/* Company Header */}
            <div className="mb-8 text-center" style={{ borderBottom: '2px solid var(--color-teal)', paddingBottom: '1rem' }}>
              <h1 className="text-3xl mb-2" style={{ color: 'var(--color-ink)' }}>PURCHASE ORDER</h1>
              <p style={{ color: 'var(--color-mercury-grey)' }}>Procinix Solutions Pvt Ltd</p>
              <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>Mumbai, Maharashtra | GSTIN: 27AABCP1234M1Z5</p>
            </div>

            {/* PO Details */}
            <div className="grid grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="mb-3" style={{ color: 'var(--color-ink)' }}>Vendor Details:</h3>
                <div className="text-sm space-y-1" style={{ color: 'var(--color-mercury-grey)' }}>
                  <p><strong style={{ color: 'var(--color-ink)' }}>Vendor:</strong> Acme Supplies Ltd</p>
                  <p><strong style={{ color: 'var(--color-ink)' }}>State:</strong> Maharashtra</p>
                  <p><strong style={{ color: 'var(--color-ink)' }}>GSTIN:</strong> 27AABCA1234M1Z5</p>
                </div>
              </div>
              <div>
                <h3 className="mb-3" style={{ color: 'var(--color-ink)' }}>Order Details:</h3>
                <div className="text-sm space-y-1" style={{ color: 'var(--color-mercury-grey)' }}>
                  <p><strong style={{ color: 'var(--color-ink)' }}>PO Number:</strong> PO-IND-2025-00001</p>
                  <p><strong style={{ color: 'var(--color-ink)' }}>PO Date:</strong> {new Date().toLocaleDateString('en-IN')}</p>
                  <p><strong style={{ color: 'var(--color-ink)' }}>Payment Terms:</strong> Net 30</p>
                  <p><strong style={{ color: 'var(--color-ink)' }}>PO Type:</strong> Catalogue PO</p>
                </div>
              </div>
            </div>
            ...
            {/* Line Items */}
            <div className="mb-8">
              <h3 className="mb-4" style={{ color: 'var(--color-ink)' }}>Line Items:</h3>
              <table className="w-full">
                <thead>
                  <tr style={{ backgroundColor: 'var(--color-cloud)', borderBottom: '2px solid var(--color-silver)' }}>
                    <th className="text-left px-4 py-3 text-sm" style={{ color: 'var(--color-mercury-grey)' }}>Sr.</th>
                ...
                <tbody>
                  {lineItems.length === 0 ? (
                    <tr>
                      <td colSpan={6} className="text-center py-8" style={{ color: 'var(--color-mercury-grey)' }}>
                        No items added
                      </td>
                    </tr>
                  ) : (
                    lineItems.map((item, index) => (
                      <tr 
                        ...
                        style={{ borderBottom: '1px solid var(--color-silver)' }}
                      >
                        <td className="px-4 py-3" style={{ color: 'var(--color-mercury-grey)' }}>{index + 1}</td>
            ...
            <div className="flex justify-end mb-8">
              <div className="w-1/2">
                <div className="flex justify-between py-2" style={{ borderBottom: '1px solid var(--color-silver)' }}>
                ...
                <div className="flex justify-between py-3" style={{ backgroundColor: '#E3F2FD', padding: '0.75rem', borderRadius: '0.5rem', marginTop: '0.5rem' }}>
                  ...
                  <span style={{ color: 'var(--color-teal)' }} className="text-xl">₹{totalPOValue.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
                </div>
              </div>
            </div>
            ...
            {/* Terms & Conditions */}
            <div className="mb-6">
              <h3 className="mb-3" style={{ color: 'var(--color-ink)' }}>General Terms and Conditions:</h3>
            ...
            <div className="mb-6">
              <h3 className="mb-3" style={{ color: 'var(--color-ink)' }}>Delivery Terms and Conditions:</h3>
              <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
            ...
            <div className="mb-6">
              <h3 className="mb-3" style={{ color: 'var(--color-ink)' }}>Payment Milestones:</h3>
              <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
            ...
            <div className="mt-12 pt-8" style={{ borderTop: '1px solid var(--color-silver)' }}>
              <div className="grid grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-sm mt-8" style={{ color: 'var(--color-mercury-grey)' }}>___________________________</p>
                  <p className="text-sm mt-1" style={{ color: 'var(--color-mercury-grey)' }}>Procinix Solutions Pvt Ltd</p>
                </div>
                <div>
                  <p style={{ color: 'var(--color-mercury-grey)' }}>Vendor Acceptance</p>
                  <p className="text-sm mt-8" style={{ color: 'var(--color-mercury-grey)' }}>___________________________</p>
                  <p className="text-sm mt-1" style={{ color: 'var(--color-mercury-grey)' }}>Acme Supplies Ltd</p>
                </div>
              </div>
            </div>
          </div>
