      ...
      <div className="p-8 max-w-7xl mx-auto">
        ...
        >
          <p className="text-sm" style={{ color: '#1E3A8A' }}>
            <strong>💡 Tip:</strong> Switch roles above and observe how the left navigation
            dynamically shows/hides sections based on permissions. Modules with view-only access
            will show an eye icon (👁️). The navigation automatically hides pillars and modules you
