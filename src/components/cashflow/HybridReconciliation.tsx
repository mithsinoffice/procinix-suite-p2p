          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <span 
                ...
                style={{ backgroundColor: 'var(--color-warning-light)', color: 'var(--color-warning-dark)', border: '1px solid #FFB74D' }}
              >
                DIRECT ↔ INDIRECT
              </span>
              <div className="flex items-center gap-1.5 px-2 py-1 rounded" style={{ backgroundColor: 'var(--color-cloud)' }}>
                ...
                <span className="text-xs" style={{ color: 'var(--color-mercury-grey)' }}>CFO Trust Builder</span>
              </div>
            </div>
      ...
      <div className="p-8">
        ...
        <div className="bg-white rounded-lg p-8" style={{ border: '1px solid var(--color-silver)' }}>
          ...
          <div className="space-y-4">
            {/* Starting Cash (Bank) */}
            <div className="flex items-center justify-between p-6 rounded-lg" style={{ backgroundColor: 'var(--color-success-light)', border: '2px solid #81C784' }}>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: 'var(--color-success-dark)' }} />
                <div>
              ...
              <p className="text-2xl" style={{ color: 'var(--color-success-dark)', fontWeight: '600' }}>
            ...
            <div className="flex items-center justify-between p-6 rounded-lg" style={{ backgroundColor: 'var(--color-cloud)', border: '1px solid var(--color-silver)' }}>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: 'var(--color-teal)' }} />
                <div>
                  <p className="text-sm" style={{ color: 'var(--color-ink)', fontWeight: '600', margin: 0 }}>
                    + Net Indirect Cash Flow
                  </p>
            ...
            {/* Timing Differences */}
            <div className="flex items-center justify-between p-6 rounded-lg" style={{ backgroundColor: 'var(--color-warning-light)', border: '1px solid #FFB74D' }}>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: 'var(--color-warning-dark)' }} />
                <div>
                  <p className="text-sm" style={{ color: 'var(--color-ink)', fontWeight: '600', margin: 0 }}>
            ...
            <div className="flex items-center justify-between p-6 rounded-lg" style={{ backgroundColor: 'var(--color-cloud)', border: '1px solid var(--color-silver)' }}>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: 'var(--color-mercury-grey)' }} />
                <div>
                  <p className="text-sm" style={{ color: 'var(--color-ink)', fontWeight: '600', margin: 0 }}>
                    ± Manual Adjustments
                  </p>
            ...
            <div className="flex justify-center">
              <div className="w-full border-t-2" style={{ borderColor: 'var(--color-silver)', margin: '20px 0' }} />
            </div>

            {/* Ending Cash */}
            <div className="flex items-center justify-between p-6 rounded-lg" style={{ backgroundColor: 'var(--color-teal-tint)', border: '2px solid var(--color-teal)' }}>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full" style={{ backgroundColor: 'var(--color-teal)' }} />
                <div>
                  <p className="text-sm" style={{ color: 'var(--color-ink)', fontWeight: '600', margin: 0 }}>
          ...
          <div className="bg-white rounded-lg" style={{ border: '1px solid var(--color-silver)' }}>
            ...
            <div className="p-6 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>AP Invoices booked not paid</span>
                <span className="text-sm" style={{ color: 'var(--color-error-dark)', fontWeight: '600' }}>-{formatCurrency(2100000)}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>AR Collections delayed</span>
                <span className="text-sm" style={{ color: 'var(--color-error-dark)', fontWeight: '600' }}>-{formatCurrency(900000)}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>Payroll accrued not paid</span>
                <span className="text-sm" style={{ color: 'var(--color-error-dark)', fontWeight: '600' }}>-{formatCurrency(200000)}</span>
              </div>
            </div>
          </div>
            ...
            <div className="p-6 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>Timing Differences</span>
                  <Info className="w-3.5 h-3.5" style={{ color: 'var(--color-mercury-grey)' }} />
                </div>
                <span className="text-sm" style={{ color: 'var(--color-warning-dark)', fontWeight: '600' }}>
                  {formatCurrency(3200000)} (91%)
                </span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>Permanent Differences</span>
                  <Info className="w-3.5 h-3.5" style={{ color: 'var(--color-mercury-grey)' }} />
                </div>
                <span className="text-sm" style={{ color: 'var(--color-error-dark)', fontWeight: '600' }}>
                  {formatCurrency(200000)} (9%)
                </span>
              </div>
              <p className="text-xs mt-4 p-3 rounded" style={{ backgroundColor: 'var(--color-cloud)', color: 'var(--color-mercury-grey)', margin: 0 }}>
