    ...
    <div style={{ backgroundColor: 'var(--color-cloud)', minHeight: '100vh' }}>
      ...
      <div className="p-8">
        <div className="grid grid-cols-3 gap-6 mb-8">
          {['Base Case', 'Scenario A: Accelerate Collections', 'Scenario B: Defer Capex'].map(
            (scenario, idx) => (
              <div
                key={scenario}
                ...
                style={{
                  border:
                    idx === 0 ? '2px solid var(--color-teal)' : '1px solid var(--color-silver)',
                }}
              >
                <h3
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p
                      className="text-base"
                      style={{
                        color: idx === 0 ? 'var(--color-error-dark)' : 'var(--color-success-dark)',
                      }}
                    >
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: 'var(--color-mercury-grey)', margin: 0 }}>
                  Reducing DSO from 52 to 45 days would free up ₹4.2 Cr in cash and eliminate buffer
                  breach in Week 7. Focus on top 5 customers with overdue invoices.
                </p>
              </div>
            </div>
          </div>
