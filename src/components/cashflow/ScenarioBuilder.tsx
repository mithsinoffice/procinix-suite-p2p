        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <h1 className="text-2xl" style={{ color: '#0A0F14', margin: 0 }}>Scenario Builder</h1>
              <span className="px-3 py-1 rounded-full text-sm" style={{ backgroundColor: '#FFF3E0', color: '#F57C00', border: '1px solid #FFB74D' }}>
                HYBRID SCENARIOS
              </span>
            </div>
      ...
      <div className="p-8">
        <div className="grid grid-cols-3 gap-6 mb-8">
          {['Base Case', 'Scenario A: Accelerate Collections', 'Scenario B: Defer Capex'].map((scenario, idx) => (
            <div key={scenario} className="bg-white rounded-lg p-6" style={{ border: idx === 0 ? '2px solid #00A9B7' : '1px solid #E1E6EA' }}>
              <h3 className="text-sm mb-4" style={{ color: '#0A0F14', fontWeight: '600' }}>{scenario}</h3>
              <div className="space-y-3">
                <div>
                  <p className="text-xs mb-1" style={{ color: '#6E7A82' }}>13-Week Ending Cash</p>
                  <p className="text-xl" style={{ color: '#0A0F14', fontWeight: '600' }}>
                    {formatCurrency(61920000 + (idx * 5000000))}
                  </p>
                </div>
                <div>
                  <p className="text-xs mb-1" style={{ color: '#6E7A82' }}>Cash Runway</p>
                  <p className="text-base" style={{ color: '#0A0F14' }}>
                    {18 + idx} months
                  </p>
                </div>
                <div>
                  <p className="text-xs mb-1" style={{ color: '#6E7A82' }}>Buffer Breaches</p>
                  <p className="text-base" style={{ color: idx === 0 ? '#DC2626' : '#2E7D32' }}>
              ...
              {idx > 0 && (
                <div className="mt-4 pt-4" style={{ borderTop: '1px solid #E1E6EA' }}>
                  <p className="text-xs" style={{ color: '#00A9B7', fontWeight: '600' }}>
        ...
        <div className="bg-white rounded-lg p-8" style={{ border: '1px solid #E1E6EA' }}>
          <h3 className="text-base mb-6" style={{ color: '#0A0F14', margin: 0 }}>Scenario Controls</h3>
          <div className="grid grid-cols-2 gap-6">
            <div>
              <label className="text-sm mb-2 block" style={{ color: '#6E7A82' }}>Days Sales Outstanding (DSO)</label>
            ...
            <div>
              <label className="text-sm mb-2 block" style={{ color: '#6E7A82' }}>Days Payable Outstanding (DPO)</label>
