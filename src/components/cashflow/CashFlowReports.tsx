...
export function CashFlowReports() {
  const reports = [
    ...
    {
      name: 'Monthly Indirect Cash Flow',
      type: 'Indirect',
      format: 'Excel, PDF',
      frequency: 'Monthly',
    },
    {
      name: 'Hybrid Reconciliation Report',
      type: 'Hybrid',
      format: 'Excel, PDF',
      frequency: 'Monthly',
    },
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'Operational':
        return { bg: '#FFF8E1', color: '#F57F17', border: '#FDD835' };
      case 'Governance':
        return { bg: '#FCE4EC', color: '#C2185B', border: '#F48FB1' };
      default:
        return {
          bg: 'var(--color-cloud)',
