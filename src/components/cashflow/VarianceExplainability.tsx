        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <h1 className="text-2xl" style={{ color: '#0A0F14', margin: 0 }}>Variance & Explainability</h1>
              <div className="flex items-center gap-1.5 px-2 py-1 rounded" style={{ backgroundColor: '#E8F7F8', border: '1px solid #00A9B7' }}>
                ...
                <span className="text-xs" style={{ color: '#00A9B7', fontWeight: '600' }}>AI NARRATIVES</span>
              </div>
            </div>
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
            <p className="text-sm mb-2" style={{ color: '#6E7A82' }}>Forecast (Week 1)</p>
            <p className="text-2xl" style={{ color: '#0A0F14', fontWeight: '600' }}>
              {formatCurrency(71420000)}
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
            <p className="text-sm mb-2" style={{ color: '#6E7A82' }}>Actual (Week 1)</p>
            <p className="text-2xl" style={{ color: '#DC2626', fontWeight: '600' }}>
              {formatCurrency(69920000)}
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
            <p className="text-sm mb-2" style={{ color: '#6E7A82' }}>Total Variance</p>
            <p className="text-2xl" style={{ color: '#DC2626', fontWeight: '600' }}>
        ...
        <div className="space-y-4">
          {variances.map((variance, idx) => {
            ...
            return (
              <div key={idx} className="bg-white rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
                <div className="p-6">
                  <div className="flex items-start gap-4">
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0`} 
                         style={{ backgroundColor: isNegative ? '#FEE2E2' : '#E8F5E9' }}>
                      {isNegative ? (
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="text-right">
                          <p className="text-sm mb-1" style={{ color: '#6E7A82' }}>Variance</p>
                          <p className="text-xl" style={{ 
                            color: isNegative ? '#DC2626' : '#2E7D32',
                            fontWeight: '600'
                          }}>
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-4 p-4 rounded-lg" style={{ backgroundColor: '#F6F9FC' }}>
                        <div>
                          <p className="text-xs mb-1" style={{ color: '#6E7A82' }}>Forecast</p>
                          <p className="text-sm" style={{ color: '#0A0F14' }}>
                            {formatCurrency(variance.forecast)}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs mb-1" style={{ color: '#6E7A82' }}>Actual</p>
                          <p className="text-sm" style={{ color: '#0A0F14' }}>
                            {formatCurrency(variance.actual)}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs mb-1" style={{ color: '#6E7A82' }}>Difference</p>
                      ...
                      <div className="mb-4">
                        <div className="flex items-start gap-2 mb-2">
                          <Info className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: '#00A9B7' }} />
                          <div>
                      ...
                      <div>
                        <p className="text-xs mb-2" style={{ color: '#6E7A82' }}>Related Items:</p>
        ...
        <div className="mt-8 bg-white rounded-lg p-6" style={{ border: '1px solid #E1E6EA' }}>
          ...
          <ul className="text-sm space-y-2" style={{ color: '#6E7A82', paddingLeft: '24px' }}>
