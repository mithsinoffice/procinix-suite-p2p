          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="flex items-center gap-1.5 px-2 py-1 rounded" style={{ backgroundColor: '#F6F9FC' }}>
                ...
                <span className="text-xs" style={{ color: '#6E7A82' }}>GL/P&L Driven</span>
              </div>
            </div>
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-4 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
            ...
            <p className="text-sm mb-2" style={{ color: '#6E7A82' }}>Net Profit (Annual)</p>
            <p className="text-2xl" style={{ color: '#0A0F14' }}>{formatCurrency(45000000)}</p>
          </div>
          <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
            <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-3" style={{ backgroundColor: '#FFF3E0' }}>
              <LineChart className="w-5 h-5" style={{ color: '#F57C00' }} />
            </div>
            <p className="text-sm mb-2" style={{ color: '#6E7A82' }}>WC Movement</p>
            <p className="text-2xl" style={{ color: '#DC2626' }}>-{formatCurrency(12000000)}</p>
          </div>
          <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
            <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-3" style={{ backgroundColor: '#E8F7F8' }}>
              <LineChart className="w-5 h-5" style={{ color: '#00A9B7' }} />
            </div>
            <p className="text-sm mb-2" style={{ color: '#6E7A82' }}>Cash Generated (Ops)</p>
            <p className="text-2xl" style={{ color: '#2E7D32' }}>{formatCurrency(33000000)}</p>
          </div>
          <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
            <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-3" style={{ backgroundColor: '#F6F9FC' }}>
              <Calendar className="w-5 h-5" style={{ color: '#6E7A82' }} />
            </div>
            <p className="text-sm mb-2" style={{ color: '#6E7A82' }}>Cash Runway</p>
            <p className="text-2xl" style={{ color: '#0A0F14' }}>18 months</p>
          </div>
        </div>

        {/* Waterfall Placeholder */}
        <div className="bg-white p-8 rounded-lg mb-8" style={{ border: '1px solid #E1E6EA' }}>
          <h3 className="text-base mb-6" style={{ color: '#0A0F14', margin: 0 }}>
            Indirect Cash Flow Waterfall (FY 2024-25)
          </h3>
          <div className="flex items-center justify-center" style={{ height: '300px', backgroundColor: '#F6F9FC', borderRadius: '8px' }}>
            <div className="text-center">
              <LineChart className="w-16 h-16 mx-auto mb-4" style={{ color: '#00A9B7' }} />
        ...
        <div className="bg-white rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
          <div className="p-6" style={{ borderBottom: '1px solid #E1E6EA' }}>
            <h3 className="text-base" style={{ color: '#0A0F14', margin: 0 }}>Monthly Cash Generation (Indirect Method)</h3>
          </div>
          <div className="p-6">
            <div className="space-y-4">
              {['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'].map((month, idx) => (
                <div key={month} className="flex items-center justify-between p-4 rounded-lg" style={{ backgroundColor: '#F6F9FC' }}>
                  <span className="text-sm" style={{ color: '#0A0F14', fontWeight: '600' }}>{month} 2025</span>
                  <div className="flex items-center gap-8">
                    <div className="text-right">
                      <p className="text-xs mb-1" style={{ color: '#6E7A82' }}>Net Profit</p>
                      <p className="text-sm" style={{ color: '#0A0F14' }}>{formatCurrency(3500000 + idx * 200000)}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-xs mb-1" style={{ color: '#6E7A82' }}>WC Change</p>
                      <p className="text-sm" style={{ color: '#DC2626' }}>-{formatCurrency(1000000)}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-xs mb-1" style={{ color: '#6E7A82' }}>Cash Generated</p>
                      <p className="text-sm" style={{ color: '#2E7D32', fontWeight: '600' }}>{formatCurrency(2500000 + idx * 200000)}</p>
                    </div>
                  </div>
                </div>
              ))}
