...
const masterRegister: MasterRegisterRow[] = [
  ...
  {
    id: 'kit-bundle-master',
    title: 'Kit / Bundle Master',
    description: 'Pre-configured kits and bundles composed of item-master SKUs for PR shortcuts.',
  ...
  {
    id: 'rate-contract-master',
    title: 'Rate Contract Master',
    description: 'Pre-negotiated vendor × item rates auto-applied to invoices.',
    route: '/masters/rate-contract-master',
    domain: 'Commercial',
    scope: 'Multi Entity',
    entity: 'Multi Entity',
    access: 'Controlled',
    ...
    icon: FileText,
    iconTint: '#0F6E56',
    iconBg: 'linear-gradient(135deg, #E1F5EE 0%, #C9F0DC 100%)',
  },
  {
    id: 'country-master',
