                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p
                      ...
                      style={{ color: 'var(--color-teal)', fontWeight: '600', margin: 0 }}
                    >
                    ...
                    <tr>
                      ...
                      >
                        <input
                          type="checkbox"
                          checked={
                            selectedPRs.length === filteredPRs.length && filteredPRs.length > 0
                          }
                          onChange={(e) => {
                            if (e.target.checked) {
                    ...
                    {filteredPRs.map((pr) => {
                      ...
                      return (
                        <tr
                          ...
                          style={{
                            backgroundColor: isSelected ? 'var(--color-teal-tint)' : 'transparent',
                          }}
                        >
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-sm mb-6" style={{ color: 'var(--color-mercury-grey)' }}>
                Choose how you want to group the selected PRs into POs. This will determine how many
                POs are created.
              </p>
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <Icon
                          ...
                          style={{
                            color: isSelected ? 'var(--color-teal)' : 'var(--color-mercury-grey)',
                          }}
                        />
                        <div>
                          <p
              ...
              <div
                className="flex items-center justify-end gap-3 mt-6 pt-6"
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm" style={{ color: 'var(--color-mercury-grey)', margin: 0 }}>
                    From {selectedPRs.length} selected PRs • Total Value:{' '}
                    {formatCurrency(
                      approvedPRs
                        .filter((pr) => selectedPRs.includes(pr.id))
                        .reduce((sum, pr) => sum + pr.totalAmount, 0)
