      ...
      <div className="bg-white px-8 py-6" style={{ borderBottom: '1px solid #E1E6EA' }}>
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex-1">
            <h1 className="text-2xl mb-1" style={{ color: '#0A0F14', margin: 0 }}>Kit/Bundle Purchase Requisition</h1>
            <p className="text-sm" style={{ color: '#6E7A82', margin: 0 }}>Create PR for products with multiple SKUs (e.g., Laptop Kit with accessories)</p>
          </div>
          ...
          <div className="col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select className="w-full px-3 py-2 rounded-lg text-sm" style={{ border: '1px solid #E1E6EA', backgroundColor: '#FFFFFF', color: '#0A0F14' }}>
                ...
                <div>
                  ...
                  <input type="date" className="w-full px-3 py-2 rounded-lg text-sm" style={{ border: '1px solid #E1E6EA', backgroundColor: '#FFFFFF', color: '#0A0F14' }} />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm mb-2" style={{ color: '#6E7A82' }}>Business Justification <span style={{ color: '#FF4E5B' }}>*</span></label>
                  <textarea className="w-full px-3 py-2 rounded-lg text-sm" rows={2} placeholder="Why are these kit/bundles needed?" style={{ border: '1px solid #E1E6EA', backgroundColor: '#FFFFFF', color: '#0A0F14' }}></textarea>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-base" style={{ color: '#0A0F14', fontWeight: '600' }}>Kit/Bundle Items</h3>
                <button 
              ...
              {bundles.length === 0 ? (
                <div className="text-center py-12" style={{ backgroundColor: '#F6F9FC', borderRadius: '8px' }}>
                  <Package className="w-12 h-12 mx-auto mb-3" style={{ color: '#6E7A82' }} />
                  <p className="text-sm mb-1" style={{ color: '#0A0F14' }}>No kit/bundles added yet</p>
                  <p className="text-sm" style={{ color: '#6E7A82' }}>Click "Add Kit/Bundle" to select from catalog</p>
                </div>
              ) : (
                <div className="space-y-4">
                  {bundles.map((bundle) => {
                    const totals = calculateBundleTotal(bundle);
                    return (
                      <div key={bundle.id} className="p-4 rounded-lg" style={{ backgroundColor: '#F6F9FC', border: '1px solid #E1E6EA' }}>
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                              <Package className="w-5 h-5" style={{ color: '#1976D2' }} />
                              <h4 className="text-base" style={{ color: '#0A0F14', fontWeight: '600' }}>{bundle.bundleName}</h4>
                        ...
                        <div className="bg-white rounded-lg overflow-hidden" style={{ border: '1px solid #E1E6EA' }}>
                          <table className="w-full">
                            <thead style={{ backgroundColor: '#F6F9FC' }}>
                              <tr>
                                <th className="px-3 py-2 text-left text-xs" style={{ color: '#6E7A82', fontWeight: '600' }}>Item Code</th>
                                <th className="px-3 py-2 text-left text-xs" style={{ color: '#6E7A82', fontWeight: '600' }}>Description</th>
                                <th className="px-3 py-2 text-center text-xs" style={{ color: '#6E7A82', fontWeight: '600' }}>Qty</th>
                                <th className="px-3 py-2 text-center text-xs" style={{ color: '#6E7A82', fontWeight: '600' }}>UOM</th>
                                <th className="px-3 py-2 text-right text-xs" style={{ color: '#6E7A82', fontWeight: '600' }}>Unit Price</th>
                                <th className="px-3 py-2 text-center text-xs" style={{ color: '#6E7A82', fontWeight: '600' }}>GST</th>
                                <th className="px-3 py-2 text-right text-xs" style={{ color: '#6E7A82', fontWeight: '600' }}>Total</th>
                                <th className="px-3 py-2 text-center text-xs" style={{ color: '#6E7A82', fontWeight: '600' }}>Type</th>
                              </tr>
                            </thead>
                            <tbody className="divide-y" style={{ borderColor: '#E1E6EA' }}>
                              {bundle.skus.map((sku) => (
                                <tr key={sku.id}>
                                  <td className="px-3 py-2 text-xs" style={{ color: '#0A0F14', fontWeight: '600' }}>{sku.itemCode}</td>
                                  <td className="px-3 py-2 text-xs" style={{ color: '#6E7A82' }}>
                                    <div>{sku.itemName}</div>
                                    <div className="text-xs" style={{ color: '#6E7A82' }}>{sku.description}</div>
                                  </td>
                                  <td className="px-3 py-2 text-xs text-center" style={{ color: '#0A0F14' }}>{sku.quantity}</td>
                                  <td className="px-3 py-2 text-xs text-center" style={{ color: '#6E7A82' }}>{sku.uom}</td>
                                  <td className="px-3 py-2 text-xs text-right" style={{ color: '#0A0F14' }}>{formatCurrency(sku.unitPrice)}</td>
                                  <td className="px-3 py-2 text-xs text-center" style={{ color: '#6E7A82' }}>{sku.gstRate}%</td>
                                  <td className="px-3 py-2 text-xs text-right" style={{ color: '#0A0F14', fontWeight: '600' }}>
                        ...
                        {/* Bundle Totals */}
                        <div className="mt-3 pt-3 flex justify-end gap-8" style={{ borderTop: '1px solid #E1E6EA' }}>
                          <div className="text-right">
                            <p className="text-xs mb-1" style={{ color: '#6E7A82' }}>Subtotal</p>
                            <p className="text-sm" style={{ color: '#0A0F14', fontWeight: '600' }}>{formatCurrency(totals.subtotal)}</p>
                          </div>
                          <div className="text-right">
                            <p className="text-xs mb-1" style={{ color: '#6E7A82' }}>GST</p>
                            <p className="text-sm" style={{ color: '#0A0F14', fontWeight: '600' }}>{formatCurrency(totals.gst)}</p>
                          </div>
                          <div className="text-right">
                            <p className="text-xs mb-1" style={{ color: '#6E7A82' }}>Total</p>
                            <p className="text-base" style={{ color: '#00A9B7', fontWeight: '600' }}>{formatCurrency(totals.total)}</p>
                          </div>
                        </div>
                      </div>
                    );
              ...
              <div className="bg-white p-6 rounded-lg" style={{ border: '2px solid #00A9B7' }}>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="text-center p-4 rounded-lg" style={{ backgroundColor: '#F6F9FC' }}>
                    <p className="text-sm mb-2" style={{ color: '#6E7A82' }}>Total Kits/Bundles</p>
                    <p className="text-2xl" style={{ color: '#0A0F14', fontWeight: '600' }}>{bundles.length}</p>
                  </div>
                  <div className="text-center p-4 rounded-lg" style={{ backgroundColor: '#F6F9FC' }}>
                    <p className="text-sm mb-2" style={{ color: '#6E7A82' }}>Total SKUs</p>
                  ...
                  <div className="text-center p-4 rounded-lg" style={{ backgroundColor: '#E8F7F8' }}>
                    <p className="text-sm mb-2" style={{ color: '#00A9B7' }}>Grand Total (incl. GST)</p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-base" style={{ color: '#0A0F14', fontWeight: '600' }}>Kit/Bundle Rules</h3>
              </div>
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: '#2E7D32' }} />
                  <span className="text-sm" style={{ color: '#6E7A82' }}>All SKUs in a bundle must be from the <strong>same vendor</strong></span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: '#2E7D32' }} />
                  <span className="text-sm" style={{ color: '#6E7A82' }}><strong>Cannot split</strong> bundle items across vendors or POs</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: '#2E7D32' }} />
                  <span className="text-sm" style={{ color: '#6E7A82' }}>Mandatory SKUs <strong>must be included</strong> in the bundle</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: '#2E7D32' }} />
                  <span className="text-sm" style={{ color: '#6E7A82' }}>Optional SKUs can be removed from bundle if not needed</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: '#2E7D32' }} />
                  <span className="text-sm" style={{ color: '#6E7A82' }}>Bundle pricing is <strong>pre-negotiated</strong> with vendor</span>
                </li>
              </ul>
            </div>
            ...
            {/* Help Guide */}
            <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
              <h3 className="text-base mb-4" style={{ color: '#0A0F14', fontWeight: '600' }}>💡 When to Use Kit/Bundle PR?</h3>
              <div className="space-y-3">
                <div className="p-3 rounded-lg" style={{ backgroundColor: '#E3F2FD' }}>
                  ...
                  <p className="text-xs" style={{ color: '#6E7A82' }}>Laptop + Mouse + Headset + Webcam as one kit</p>
                </div>
                <div className="p-3 rounded-lg" style={{ backgroundColor: '#E8F5E9' }}>
                  <p className="text-sm mb-1" style={{ color: '#2E7D32', fontWeight: '600' }}>Desktop Setup</p>
                  <p className="text-xs" style={{ color: '#6E7A82' }}>CPU + Monitor + Keyboard + Mouse + Speakers</p>
                </div>
                <div className="p-3 rounded-lg" style={{ backgroundColor: '#FFF3E0' }}>
                  <p className="text-sm mb-1" style={{ color: '#F57C00', fontWeight: '600' }}>Conference Room</p>
                  <p className="text-xs" style={{ color: '#6E7A82' }}>Projector + Screen + AV System + Cables</p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid #E1E6EA' }}>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm" style={{ color: '#6E7A82' }}>IT Budget Available</span>
                    <span className="text-sm" style={{ color: '#0A0F14', fontWeight: '600' }}>₹25,00,000</span>
                  </div>
                  <div className="flex items-center justify-between">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg w-4/5 max-h-[90vh] overflow-hidden">
            <div className="flex items-center justify-between p-6" style={{ borderBottom: '1px solid #E1E6EA' }}>
              <h2 className="text-xl" style={{ color: '#0A0F14', fontWeight: '600' }}>Select Kit/Bundle from Catalog</h2>
              ...
              <div className="space-y-4">
                {bundleCatalog.map((bundle) => (
                  <div 
                    ...
                    style={{ 
                      border: selectedBundle?.id === bundle.id ? '2px solid #1976D2' : '1px solid #E1E6EA',
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h4 className="text-base mb-1" style={{ color: '#0A0F14', fontWeight: '600' }}>{bundle.bundleName}</h4>
                        <p className="text-sm mb-1" style={{ color: '#6E7A82' }}>Code: {bundle.bundleCode}</p>
                        <p className="text-sm" style={{ color: '#6E7A82' }}>Vendor: {bundle.vendor}</p>
                      </div>
                      <div className="text-right">
                        <p className="text-sm mb-1" style={{ color: '#6E7A82' }}>{bundle.skus.length} SKUs</p>
                        ...
                        <p className="text-xs" style={{ color: '#6E7A82' }}>per kit (excl. GST)</p>
                      </div>
                    </div>

                    <div className="grid grid-cols-2 gap-2">
                      {bundle.skus.map((sku) => (
                        <div key={sku.id} className="text-xs p-2 rounded" style={{ backgroundColor: '#F6F9FC' }}>
                          <span style={{ color: '#0A0F14', fontWeight: '600' }}>{sku.itemName}</span>
            ...
            <div className="flex items-center justify-between p-6" style={{ borderTop: '1px solid #E1E6EA' }}>
              <div className="flex items-center gap-4">
                <label className="text-sm" style={{ color: '#6E7A82' }}>Quantity:</label>
                <input 
                  type="number" 
                  min="1" 
                  value={bundleQty}
                  ...
                  style={{ border: '1px solid #E1E6EA', backgroundColor: '#FFFFFF', color: '#0A0F14' }}
                />
                <span className="text-sm" style={{ color: '#6E7A82' }}>kit(s)</span>
              </div>
              <div className="flex items-center gap-3">
                <button 
                ...
                <button 
                  ...
                  className="px-4 py-2 rounded-lg text-white"
                  style={{ 
                    backgroundColor: selectedBundle ? '#1976D2' : '#E1E6EA',
