...
export function ServicePRForm() {
  ...
  const submitPurchaseRequest = (status: PurchaseRequestStatus) => {
    ...
    addPurchaseRequest({
      ...
      justification:
        serviceDescription || (serviceType ? `${serviceType} service request` : 'Service request'),
      ...
      <div className="grid grid-cols-3 gap-6">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              <Upload
                className="w-5 h-5"
                style={{
                  color: sowUploaded ? 'var(--color-success-dark)' : 'var(--color-mercury-grey)',
                }}
              />
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs" style={{ color: 'var(--color-mercury-grey)' }}>
                      Uploaded on Dec 15, 2024 • 2.3 MB
                    </p>
                  </div>
                </div>
                <button
          ...
          >
            ...
            {milestones.length === 0 ? (
              ...
              >
                ...
                <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
                  Add milestones to structure payment schedule
                </p>
              </div>
            ) : (
              <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="col-span-2">
                        <label
                          ...
                          style={{ color: 'var(--color-mercury-grey)' }}
                        >
                          Deliverable <span style={{ color: 'var(--color-error)' }}>*</span>
                        </label>
                        <input
                          type="text"
                          value={milestone.deliverable}
                          onChange={(e) =>
                            handleUpdateMilestone(milestone.id, 'deliverable', e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleUpdateMilestone(milestone.id, 'dueDate', e.target.value)
                          }
                          className="px-input-compact"
                        />
                      </div>
                      <div>
                        <label
                          ...
                          style={{ color: 'var(--color-mercury-grey)' }}
                        >
                          Payment % <span style={{ color: 'var(--color-error)' }}>*</span>
                        </label>
                        <input
                          type="number"
                          min="0"
                      ...
                      <div>
                        <label
                          ...
                          style={{ color: 'var(--color-mercury-grey)' }}
                        >
                          GL Account <span style={{ color: 'var(--color-error)' }}>*</span>
                        </label>
                        <select
                          value={milestone.glAccount}
                          onChange={(e) =>
                            handleUpdateMilestone(milestone.id, 'glAccount', e.target.value)
                          }
                ...
                >
                  <div className="text-right">
                    ...
                    <p
                      className={`text-base ${totalPercentage === 100 ? 'text-green-600' : 'text-red-600'}`}
                ...
                {totalPercentage !== 100 && milestones.length > 0 && (
                  ...
                  >
                    ...
                    <span className="text-sm" style={{ color: 'var(--color-error-dark)' }}>
                      Milestone percentages must add up to 100% (currently{' '}
                      {totalPercentage.toFixed(1)}%)
                    </span>
                  </div>
                )}
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                <div
                  className={`w-4 h-4 rounded-full mt-0.5 flex items-center justify-center ${sowUploaded ? 'bg-green-100' : 'bg-red-100'}`}
                >
                  {sowUploaded ? (
                    <CheckCircle
                      className="w-3 h-3"
                    ...
                    <span className="text-xs" style={{ color: 'var(--color-error-dark)' }}>
                      !
                    </span>
                  )}
                </div>
              ...
              <li className="flex items-start gap-2">
                <div
                  className={`w-4 h-4 rounded-full mt-0.5 flex items-center justify-center ${milestones.length > 0 ? 'bg-green-100' : 'bg-red-100'}`}
                >
                  {milestones.length > 0 ? (
                    <CheckCircle
                      className="w-3 h-3"
              ...
              <li className="flex items-start gap-2">
                <div
                  className={`w-4 h-4 rounded-full mt-0.5 flex items-center justify-center ${totalPercentage === 100 ? 'bg-green-100' : 'bg-red-100'}`}
                >
                  {totalPercentage === 100 ? (
                    <CheckCircle
                      className="w-3 h-3"
          ...
          <div
            ...
            style={{ border: '1px solid var(--color-silver)' }}
          >
            <h3 className="text-base mb-4" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>
            ...
            <div className="space-y-3">
              <div className="p-3 rounded-lg" style={{ backgroundColor: '#E3F2FD' }}>
                ...
                <p className="text-xs" style={{ color: 'var(--color-mercury-grey)' }}>
                  Strategy, process improvement, advisory
                </p>
              </div>
              <div
