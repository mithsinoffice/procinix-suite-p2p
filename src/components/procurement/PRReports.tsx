    ...
    <div style={{ backgroundColor: 'var(--color-cloud)', minHeight: '100vh' }}>
      <div className="bg-white px-8 py-6" style={{ borderBottom: '1px solid var(--color-silver)' }}>
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl mb-2" style={{ color: 'var(--color-ink)', margin: 0 }}>PR Reports & Analytics</h1>
            <p className="text-sm" style={{ color: 'var(--color-mercury-grey)', margin: 0 }}>Insights into procurement requisition patterns</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-8">
        <div className="grid grid-cols-4 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid var(--color-silver)' }}>
            ...
            <p className="text-sm mb-2" style={{ color: 'var(--color-mercury-grey)' }}>Total PRs (This Month)</p>
            <p className="text-2xl mb-1" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>124</p>
            <p className="text-xs" style={{ color: 'var(--color-success-dark)' }}>↑ 12% vs last month</p>
          </div>
          <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid var(--color-silver)' }}>
            ...
            <p className="text-sm mb-2" style={{ color: 'var(--color-mercury-grey)' }}>Total PR Value</p>
            <p className="text-2xl mb-1" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>{formatCurrency(34500000)}</p>
            <p className="text-xs" style={{ color: 'var(--color-success-dark)' }}>↑ 8% vs last month</p>
          </div>
          <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid var(--color-silver)' }}>
            ...
            <p className="text-sm mb-2" style={{ color: 'var(--color-mercury-grey)' }}>Avg Approval Time</p>
            <p className="text-2xl mb-1" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>2.8 days</p>
            <p className="text-xs" style={{ color: 'var(--color-success-dark)' }}>↓ 0.5 days vs last month</p>
          </div>
          <div className="bg-white p-6 rounded-lg" style={{ border: '1px solid var(--color-silver)' }}>
            ...
            <p className="text-sm mb-2" style={{ color: 'var(--color-mercury-grey)' }}>PR → PO Conversion</p>
            <p className="text-2xl mb-1" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>87%</p>
            <p className="text-xs" style={{ color: 'var(--color-success-dark)' }}>↑ 3% vs last month</p>
          </div>
        </div>
            ...
            <div key={idx} className="bg-white rounded-lg p-6" style={{ border: '1px solid var(--color-silver)' }}>
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-sm" style={{ color: 'var(--color-mercury-grey)', margin: 0 }}>{report.description}</p>
                </div>
