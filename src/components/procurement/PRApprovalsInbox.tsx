  ...
  const getPolicyFlagColor = (flag: PolicyFlag) => {
    switch (flag) {
      ...
      case 'Price Variance':
        return { bg: 'var(--color-warning-light)', color: 'var(--color-warning-dark)' };
      case 'Missing Docs':
        return { bg: '#FFE5E5', color: 'var(--color-error-dark)' };
      default:
        return { bg: 'var(--color-cloud)', color: 'var(--color-mercury-grey)' };
    }
  };
      ...
      <div className="p-8">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm mb-3" style={{ color: 'var(--color-mercury-grey)' }}>
                      Requested by{' '}
                      <strong style={{ color: 'var(--color-ink)' }}>{pr.requestor}</strong> •{' '}
                      {pr.department} • {pr.costCentre}
                    </p>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-sm" style={{ color: agingColor, fontWeight: '600' }}>
                          {pr.agingDays} days
                        </p>
                      </div>
                      <div>
        ...
        {filteredPRs.length === 0 && (
          ...
          >
            ...
            />
            <h3 className="text-base mb-2" style={{ color: 'var(--color-ink)', fontWeight: '600' }}>
              No Pending Approvals
            </h3>
            <p className="text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
              You're all caught up! No PRs require your approval at this time.
            </p>
          </div>
        )}
      </div>
