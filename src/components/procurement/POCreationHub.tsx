...
import { FileText, ShoppingCart, ArrowRight, Package, CheckCircle, AlertCircle } from 'lucide-react';
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm" style={{ color: 'var(--color-mercury-grey)' }}>
              ...
              <li className="flex items-start gap-2">
                ...
                <span><strong>Choose "PO without PR"</strong> for urgent procurement, vendor advances, or situations where creating a PR first would cause delays. Note: This typically requires higher approval authority.</span>
              </li>
            </ul>
          </div>
        </div>
