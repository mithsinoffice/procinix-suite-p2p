        ...
        >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-white text-base md:text-lg">
                        linkedin.com/in/mithileshtiwari
                      </span>
                    </div>
                    <div className="flex items-center gap-4">
          ...
          >
            <div className="h-full flex flex-col justify-center px-12 md:px-16 py-12">
              <h3 className="text-cyan-400 text-2xl md:text-3xl tracking-wider mb-8 uppercase">
                Our Core Offerings
              </h3>

              <div className="space-y-8">
                <div>
                  <h4 className="text-amber-400 text-xl md:text-2xl mb-3 uppercase tracking-wide">
                    Finance Automation
                  </h4>
