                ...
                {customers.map((customer) => {
                  ...
                  return (
                    <tr
                      key={customer.id}
                      style={{
                        backgroundColor: isOverLimit ? 'var(--color-error-light)' : '#FFFFFF',
                      }}
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <p
                          className="text-sm mb-1"
                          style={{
                            color: isOverLimit ? 'var(--color-error-dark)' : 'var(--color-ink)',
                            fontWeight: '600',
                            margin: 0,
                          }}
                        >
                      ...
                      <td
                        ...
                        style={{
                          ...
                          fontWeight: customer.overdue > 0 ? '600' : 'normal',
                        }}
                      >
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm" style={{ color: 'var(--color-mercury-grey)', margin: 0 }}>
                Customer CUST-004 (Infosys Technologies) has exceeded credit limit by ₹2.1 Cr with
                ₹8.9 Cr overdue. Recommendation: Block new orders until outstanding is reduced below
                90% of credit limit.
              </p>
            </div>
          </div>
