        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm" style={{ color: 'var(--color-mercury-grey)', margin: 0 }}>
                Focus on Infosys (₹8.9 Cr overdue) - 65% recovery probability. Historical data shows
                they respond best to senior management contact. Expected cash inflow: ₹5.8 Cr within
                2 weeks if escalated today.
              </p>
            </div>
          </div>
        </div>
