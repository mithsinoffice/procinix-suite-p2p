...
export function ARReports() {
  const reports = [
    ...
    },
    {
      ...
      description: 'Detailed customer-wise outstanding',
      type: 'Operational',
      frequency: 'Daily',
    },
    {
    ...
    {
      name: 'DSO Trend Report',
      description: 'Days sales outstanding trend analysis',
      type: 'Analysis',
      frequency: 'Monthly',
    },
    {
      name: 'Credit Note Analysis',
      description: 'Credit notes by reason and customer',
      type: 'Analysis',
      frequency: 'Monthly',
    },
    {
    ...
    {
      name: 'Bad Debt Risk Report',
      description: 'AI-driven bad debt risk assessment',
      type: 'Strategic',
      frequency: 'Weekly',
    },
    {
      name: 'Cash Flow Forecast (AR)',
      description: 'Expected collection timeline',
      type: 'Strategic',
      frequency: 'Weekly',
    },
  ];
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'Strategic':
        return { bg: '#E3F2FD', color: '#1976D2', border: '#64B5F6' };
      default:
        return {
          bg: 'var(--color-cloud)',
    ...
    <div style={{ backgroundColor: 'var(--color-cloud)', minHeight: '100vh' }}>
      ...
      <div className="p-8">
        ...
        >
          ...
          <p className="text-sm" style={{ color: 'var(--color-mercury-grey)', margin: 0 }}>
            All AR reports integrate with Cash Flow AI module. Expected collection data feeds
            directly into 13-week and monthly forecasts with probability-weighted projections.
            Drill-down from Cash Flow → Collections → Invoice → Customer is fully supported.
          </p>
        </div>
      </div>
    </div>
