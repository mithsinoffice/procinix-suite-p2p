...
export function SalesInvoices() {
  ...
  const stats = {
    ...
    outstanding: invoices
      ...
      .reduce((sum, i) => sum + i.netAmount - (i.paidAmount || 0), 0),
  };
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm" style={{ color: 'var(--color-mercury-grey)', margin: 0 }}>
                Invoice INV-2024-004 for Infosys Technologies is 55 days outstanding with 85%
                probability of payment delay beyond 90 days. Customer has exceeded credit limit.
                Recommend: Escalate to collections team and consider dispute resolution.
              </p>
            </div>
          </div>
        </div>
