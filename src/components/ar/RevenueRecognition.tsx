        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm" style={{ color: 'var(--color-mercury-grey)', margin: 0 }}>
              Manage revenue recognition schedules and rules
            </p>
          </div>
        </div>
      </div>
                  ...
                  return (
                    <tr key={rev.id}>
                      ...
                      <td
                        ...
                        style={{ color: 'var(--color-ink)', fontWeight: '600' }}
                      >
                        {formatCurrency(rev.totalRevenue)}
                      </td>
                      <td
                        className="px-6 py-4 text-sm text-right"
                        style={{ color: 'var(--color-success-dark)', fontWeight: '600' }}
                      >
                        {formatCurrency(rev.recognized)}
                      </td>
                      <td
                        className="px-6 py-4 text-sm text-right"
                        style={{ color: 'var(--color-warning-dark)', fontWeight: '600' }}
                      >
                        {formatCurrency(rev.deferred)}
                      </td>
                      <td
                        className="px-6 py-4 text-sm"
