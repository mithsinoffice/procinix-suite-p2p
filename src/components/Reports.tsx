import { FileText, Download, Calendar, TrendingUp, Package, AlertCircle, Shield, BarChart3, DollarSign, Users, Activity } from 'lucide-react';
...
const standardReports = [
  {
    ...
    description: 'Track all transactions submitted for approval across all masters with complete workflow history, status tracking, and approval timeline',
    icon: FileText,
  ...
  },
  {
    ...
    description: 'Complete audit log of all system activities including user actions, workflow approvals, master data changes, and security events with field-level tracking',
    icon: Shield,
