      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          {[1, 2, 3, 4, 5].map(i => (
            ...
            >
              <span style={{ fontSize: '12px', color: 'var(--color-mercury-grey)' }}>Nav Item {i}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        >
          <div style={{ 
            ...
            <span style={{ fontSize: '13px', color: 'var(--color-mercury-grey)' }}>Global Context Bar</span>
          </div>
        </div>

        {/* Page Header */}
        <div style={{ backgroundColor: '#FFFFFF', padding: '24px 32px', borderBottom: '1px solid var(--color-silver)' }}>
