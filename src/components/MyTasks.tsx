  ...
  return (
    <div style={{ padding: '24px', backgroundColor: '#F6F9FC', minHeight: '100vh' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px', marginBottom: '24px' }}>
        <div style={{ backgroundColor: '#FFFFFF', padding: '20px', borderRadius: '12px', border: '1px solid #E1E6EA' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '8px', backgroundColor: '#E8F7F8', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Clock style={{ width: '20px', height: '20px', color: '#00A9B7' }} />
            </div>
            <div>
              <p style={{ fontSize: '12px', color: '#6E7A82', margin: 0 }}>Pending</p>
              <p style={{ fontSize: '24px', fontWeight: '600', color: '#0A0F14', margin: '4px 0 0 0' }}>5</p>
            </div>
          </div>
        </div>
        ...
        <div style={{ backgroundColor: '#FFFFFF', padding: '20px', borderRadius: '12px', border: '1px solid #E1E6EA' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              <p style={{ fontSize: '12px', color: '#6E7A82', margin: 0 }}>Overdue</p>
              <p style={{ fontSize: '24px', fontWeight: '600', color: '#0A0F14', margin: '4px 0 0 0' }}>2</p>
            </div>
          </div>
        </div>
        ...
        <div style={{ backgroundColor: '#FFFFFF', padding: '20px', borderRadius: '12px', border: '1px solid #E1E6EA' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              <p style={{ fontSize: '12px', color: '#6E7A82', margin: 0 }}>Completed</p>
              <p style={{ fontSize: '24px', fontWeight: '600', color: '#0A0F14', margin: '4px 0 0 0' }}>18</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ backgroundColor: '#FFFFFF', borderRadius: '12px', border: '1px solid #E1E6EA' }}>
        {/* Header */}
        <div style={{ padding: '16px 20px', borderBottom: '1px solid #E1E6EA', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ padding: '60px 20px', textAlign: 'center' }}>
          <div style={{ width: '48px', height: '48px', borderRadius: '12px', backgroundColor: '#F6F9FC', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
            <CheckCircle style={{ width: '24px', height: '24px', color: '#6E7A82' }} />
          </div>
