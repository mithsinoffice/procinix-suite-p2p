...
export const CFOApprovals = () => {
  return (
    <DeskLayoutShell deskName="CFO Desk" pageName="Approvals">
      ...
      >
        <h3 style={{ fontSize: '16px', color: 'var(--color-ink)', margin: '0 0 16px 0' }}>Pending Approvals</h3>
        <div style={{ 
          padding: '48px', 
          backgroundColor: 'var(--color-cloud)', 
          border: '1px dashed var(--color-silver)', 
          ...
          <span style={{ fontSize: '12px', color: 'var(--color-mercury-grey)' }}>Action Table Placeholder</span>
        </div>
      </div>
    </DeskLayoutShell>
  );
