...
const DashboardsHub = lazy(() => import('./components/DashboardsHub').then((module) => ({ default: module.DashboardsHub })));
const Masters = lazy(() => import('./components/Masters').then((module) => ({ default: module.Masters })));
const VendorManagement = lazy(() => import('./components/VendorManagement').then((module) => ({ default: module.VendorManagement })));
const InviteVendors = lazy(() => import('./components/InviteVendors').then((module) => ({ default: module.InviteVendors })));
const VendorReview = lazy(() => import('./components/VendorReview').then((module) => ({ default: module.VendorReview })));
const VendorInvitationPortal = lazy(() =>
  import('./components/VendorInvitationPortal').then((module) => ({ default: module.VendorInvitationPortal }))
);
...
const SizeMaster = lazy(() => import('./components/SizeMaster').then((module) => ({ default: module.SizeMaster })));
const SKUMaster = lazy(() => import('./components/SKUMaster').then((module) => ({ default: module.SKUMaster })));
const ContractMaster = lazy(() => import('./components/ContractMaster').then((module) => ({ default: module.ContractMaster })));
const CountryMaster = lazy(() => import('./components/CountryMaster').then((module) => ({ default: module.CountryMaster })));
const StateMaster = lazy(() => import('./components/StateMaster').then((module) => ({ default: module.StateMaster })));
const TaxCodeMaster = lazy(() => import('./components/TaxCodeMaster').then((module) => ({ default: module.TaxCodeMaster })));
const EmployeeMaster = lazy(() => import('./components/EmployeeMaster').then((module) => ({ default: module.EmployeeMaster })));
const DepartmentMaster = lazy(() => import('./components/DepartmentMaster').then((module) => ({ default: module.DepartmentMaster })));
const CostCentreMaster = lazy(() => import('./components/CostCentreMaster').then((module) => ({ default: module.CostCentreMaster })));
const ProfitCentreMaster = lazy(() => import('./components/ProfitCentreMaster').then((module) => ({ default: module.ProfitCentreMaster })));
const EntityMaster = lazy(() => import('./components/EntityMaster').then((module) => ({ default: module.EntityMaster })));
const CurrencyMaster = lazy(() => import('./components/CurrencyMaster').then((module) => ({ default: module.CurrencyMaster })));
const ExchangeRateMaster = lazy(() => import('./components/ExchangeRateMaster').then((module) => ({ default: module.ExchangeRateMaster })));
const UserMaster = lazy(() => import('./components/UserMaster').then((module) => ({ default: module.UserMaster })));
...
const ProcurementHeadDesk = lazy(() => import('./components/ProcurementHeadDesk').then((module) => ({ default: module.ProcurementHeadDesk })));
const CFODesk = lazy(() => import('./components/CFODesk').then((module) => ({ default: module.CFODesk })));
const ManagementDesk = lazy(() => import('./components/ManagementDesk').then((module) => ({ default: module.ManagementDesk })));
const WorkflowReport = lazy(() => import('./components/WorkflowReport').then((module) => ({ default: module.WorkflowReport })));
const PaymentsDashboard = lazy(() => import('./components/PaymentsDashboard').then((module) => ({ default: module.PaymentsDashboard })));
const PaymentProposal = lazy(() => import('./components/PaymentProposal').then((module) => ({ default: module.PaymentProposal })));
const PaymentBatches = lazy(() => import('./components/PaymentBatches').then((module) => ({ default: module.PaymentBatches })));
const PaymentApproval = lazy(() => import('./components/PaymentApproval').then((module) => ({ default: module.PaymentApproval })));
const PaymentAgingDashboard = lazy(() => import('./components/PaymentAgingDashboard').then((module) => ({ default: module.PaymentAgingDashboard })));
const BankIntegrationManagement = lazy(() => import('./components/BankIntegrationManagement').then((module) => ({ default: module.BankIntegrationManagement })));
const PaymentAuditTrail = lazy(() => import('./components/PaymentAuditTrail').then((module) => ({ default: module.PaymentAuditTrail })));
const AISuggestedPaymentBatch = lazy(() => import('./components/AISuggestedPaymentBatch').then((module) => ({ default: module.AISuggestedPaymentBatch })));
const MSMEPaymentDashboard = lazy(() => import('./components/MSMEPaymentDashboard').then((module) => ({ default: module.MSMEPaymentDashboard })));
const BudgetDashboard = lazy(() => import('./components/BudgetDashboard').then((module) => ({ default: module.BudgetDashboard })));
const BudgetPlanningCreation = lazy(() => import('./components/BudgetPlanningCreation').then((module) => ({ default: module.BudgetPlanningCreation })));
const BudgetPhasing = lazy(() => import('./components/BudgetPhasing').then((module) => ({ default: module.BudgetPhasing })));
const BudgetApprovalWorkflow = lazy(() => import('./components/BudgetApprovalWorkflow').then((module) => ({ default: module.BudgetApprovalWorkflow })));
const BudgetConsumptionControl = lazy(() => import('./components/BudgetConsumptionControl').then((module) => ({ default: module.BudgetConsumptionControl })));
const InterimRevisedBudgets = lazy(() => import('./components/InterimRevisedBudgets').then((module) => ({ default: module.InterimRevisedBudgets })));
const BudgetTransfers = lazy(() => import('./components/BudgetTransfers').then((module) => ({ default: module.BudgetTransfers })));
const WhatIfScenarios = lazy(() => import('./components/WhatIfScenarios').then((module) => ({ default: module.WhatIfScenarios })));
const BudgetPolicies = lazy(() => import('./components/BudgetPolicies').then((module) => ({ default: module.BudgetPolicies })));
const APDashboard = lazy(() => import('./components/APDashboard').then((module) => ({ default: module.APDashboard })));
const APReports = lazy(() => import('./components/APReports').then((module) => ({ default: module.APReports })));
const CashPosition = lazy(() => import('./components/cashflow/CashPosition').then((module) => ({ default: module.CashPosition })));
const WeekForecast13 = lazy(() => import('./components/cashflow/WeekForecast13').then((module) => ({ default: module.WeekForecast13 })));
const MonthlyAnnualForecast = lazy(() => import('./components/cashflow/MonthlyAnnualForecast').then((module) => ({ default: module.MonthlyAnnualForecast })));
const HybridReconciliation = lazy(() => import('./components/cashflow/HybridReconciliation').then((module) => ({ default: module.HybridReconciliation })));
const ScenarioBuilder = lazy(() => import('./components/cashflow/ScenarioBuilder').then((module) => ({ default: module.ScenarioBuilder })));
const AIActions = lazy(() => import('./components/cashflow/AIActions').then((module) => ({ default: module.AIActions })));
const VarianceExplainability = lazy(() => import('./components/cashflow/VarianceExplainability').then((module) => ({ default: module.VarianceExplainability })));
const CashFlowReports = lazy(() => import('./components/cashflow/CashFlowReports').then((module) => ({ default: module.CashFlowReports })));
const CashFlowSettings = lazy(() => import('./components/cashflow/CashFlowSettings').then((module) => ({ default: module.CashFlowSettings })));
                  ...
                  <DashboardDataProvider>
                    ...
                    <Route path="/" element={<DashboardLayout />}>
                      ...
                      <Route path="vendor-management" element={<VendorManagement />}>
                        ...
                        <Route path="governance-desk" element={<VendorGovernanceDesk />} />
                      ...
                      <Route path="advances/hub" element={<Navigate to="/ap/advances/hub" replace />} />
