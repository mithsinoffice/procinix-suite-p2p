    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: "masters/approval-workflow", element: <ApprovalWorkflow /> },
          ...
          { path: "masters/workflow-configurator", element: <WorkflowConfigurator /> },
          ...
          { path: "ap/advances", element: <AdvancesHub /> },
          ...
          { path: "advances/hub", loader: () => redirect("/ap/advances") },
