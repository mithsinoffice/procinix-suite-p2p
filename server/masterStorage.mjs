export const MASTER_STORAGE = {
  ...
  country_master: {
    ...
    auditTable: 'country_master_audit',
    legacyTable: 'erp_master_countries',
  },
  state_master: {
    database: 'state_master',
    table: 'state_master',
    auditTable: 'state_master_audit',
    legacyTable: 'erp_master_states',
  },
  department_master: {
    database: 'department_master',
    table: 'department_master',
    auditTable: 'department_master_audit',
    legacyTable: 'erp_master_departments',
  },
  tax_code_master: {
    database: 'tax_code_master',
  ...
  item_category_master: {
    ...
    auditTable: 'item_category_master_audit',
    legacyTable: 'erp_master_item_categories',
  },
  vendor_payment_terms_master: {
    database: 'vendor_payment_terms_master',
  ...
  uom_master: {
    database: 'uom_master',
    table: 'uom_master',
    auditTable: 'uom_master_audit',
    legacyTable: 'erp_master_uoms',
  },
  debit_note_reason_master: {
    database: 'debit_note_reason_master',
    table: 'debit_note_reason_master',
    auditTable: 'debit_note_reason_master_audit',
    legacyTable: 'erp_master_debit_note_reasons',
  },
  cost_centre_master: {
    database: 'cost_centre_master',
    table: 'cost_centre_master',
    auditTable: 'cost_centre_master_audit',
    legacyTable: 'erp_master_cost_centres',
  },
  profit_centre_master: {
    database: 'profit_centre_master',
    table: 'profit_centre_master',
    auditTable: 'profit_centre_master_audit',
    legacyTable: 'erp_master_profit_centres',
  },
  employee_master: {
    database: 'employee_master',
    table: 'employee_master',
    auditTable: 'employee_master_audit',
    legacyTable: 'erp_master_employees',
  },
  contract_master: {
    database: 'contract_master',
    table: 'contract_master',
    auditTable: 'contract_master_audit',
    legacyTable: 'erp_master_contracts',
  },
  roles_master: {
    database: 'roles_master',
    table: 'roles_master',
    auditTable: 'roles_master_audit',
    legacyTable: 'erp_master_roles',
  },
  user_master: {
    database: 'user_master',
    table: 'user_master',
    auditTable: 'user_master_audit',
    legacyTable: 'erp_master_users',
  },
  currency_master: {
    database: 'currency_master',
    table: 'currency_master',
    auditTable: 'currency_master_audit',
    legacyTable: 'erp_master_currencies',
  },
  entity_master: {
    database: 'entity_master',
    table: 'entity_master',
    auditTable: 'entity_master_audit',
    legacyTable: 'erp_master_entities',
  },
  exchange_rate_master: {
    database: 'exchange_rate_master',
    table: 'exchange_rate_master',
    auditTable: 'exchange_rate_master_audit',
    legacyTable: 'erp_master_exchange_rates',
  },
  vendor_master: {
    database: 'vendor_master',
    table: 'vendor_master',
    auditTable: 'vendor_master_audit',
    legacyTable: 'erp_master_vendors',
  },
  account_code_master: {
    database: 'account_code_master',
    table: 'account_code_master',
    auditTable: 'account_code_master_audit',
    legacyTable: 'erp_master_account_codes',
  },
  bank_master: {
    database: 'bank_master',
    table: 'bank_master',
  ...
  tds_section_master: {
    ...
    auditTable: 'tds_section_master_audit',
    legacyTable: 'erp_master_tds_sections',
  },
  location_master: {
    database: 'location_master',
    table: 'location_master',
    auditTable: 'location_master_audit',
    legacyTable: 'erp_master_locations',
  },
  item_master: {
    database: 'item_master',
    table: 'item_master',
    auditTable: 'item_master_audit',
    legacyTable: 'item_master',
  },
  gl_code_master: {
    database: 'gl_code_master',
    table: 'gl_code_master',
